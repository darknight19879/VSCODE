public class App {
    public static void main(String[] args) throws Exception{
         ...
         */
        Wizard ursula = new Wizard("Ursula");
        Warlock Moogellan = new Warlock("Moogellan");
        ursula.HydroCannon(Moogellan);

        System.out.println("\n" + Moogellan.characterName);
        System.out.println("HP left is " + Moogellan.healthPoints);
        System.out.println("Mana left is " + Moogellan.manaPoints);
        System.out.println(" ");

        Moogellan.earthquake(ursula);
        System.out.println("\n" + ursula.characterName);
        System.out.println("HP left is " + ursula.healthPoints);
        System.out.println("Mana left is " + ursula.manaPoints);
        System.out.println(" ");
        ...
        Moogellan.recover(Moogellan);
        System.out.println(Moogellan.characterName + " has total HP of " + Moogellan.healthPoints
                + " and total of Mana is " + Moogellan.manaPoints);
        System.out.println(" ");
        System.out.println(Moogellan.characterName);
        System.out.println("HP left is " + Moogellan.healthPoints);
        System.out.println("Mana left is " + Moogellan.manaPoints);
        System.out.println(" ");
